...
export default function Modal({isOpen, onClose}: ModalProps){
    ...
    <div data-aos='zoom-in' data-aos-duration="600" className="fixed inset-0 z-50 flex items-center justify-center">
        ...
        <div className=" relative z-10 h-[90%] sm:h-auto max-h-140 w-full max-w-98 sm:max-w-100 min-w-98 sm:min-w-100 bg-purple-900/30 p-6 sm:p-6 lg:p-8 border-1 border-purple-500/60 rounded-2xl sm:rounded-3xl shadow-2xl shadow-purple-900/30 flex flex-col mx-1 sm:mx-0" >
