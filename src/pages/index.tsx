...
export default function Home() {
  ...
  <AOSWrapper>
    ...
    <div className="min-h-screen min-w-screen max-w-1000">
      <header className="min-w-full min-h-10 sm:min-h-13 flex justify-center items-center gap-5 sm:gap-10 font-bold bg-transparent backdrop-blur-sm border-b-2 border-purple-500/30 shadow-2xl/20 z-50 sticky top-0">
      ...
      <div className="min-h-180 w-full gap-5 flex flex-col justify-center items-center pb-30"  
       >
        <h2 data-aos="fade-in" className="font-medium text-md sm:text-2xl text-slate-200">Olá visitante seja bem-vindo(a)! 👋 </h2>
        <div
        >
        <Image
        src='/me.jpeg'
        ...
        height={170}
        quality={100}
        className="rounded-full shadow-2xl/65 border-2 border-purple-400 w-40 h-40 sm:w-full sm:h-full"
        data-aos='fade-in' 
        />          
        </div>
        <h1 data-aos='fade-in' className="font-bold text-2xl sm:text-4xl mb-5 text-white">Me chamo Ryan da Costa</h1>
      </div>
      <div data-aos='fade-down' data-aos-duration="1400" id="about" className=" min-h-150 pb-15 font-bold text-base sm:text-lg flex flex-col  gap-10 sm:gap-15 justify-center items-center text-center">
        <p className="text-4xl text-purple-300">Sobre</p>
        <p className="text-md p-3 sm:text-inherit text-slate-200">
      ...
      <div data-aos="fade-down" data-aos-duration='800' id='knowledge' className="min-h-150 w-full flex flex-col max-w-full justify-center items-center mr-10 p-10 pt-7 xl:pt-15 xl:p-10">
        <h1 className="text-4xl font-bold text-purple-300">Conhecimentos</h1>
        <Knowledge/>
      </div>
      <div id='projects' data-aos="fade-down" data-aos-duration='800' className="min-h-auto my-30 pt-15 p-10"> <Carousel/></div>
      </main>
      <footer id="contacts" className="h-full sm:h-40 flex justify-center border-t-1 border-purple-500/30 bg-purple-900/20">
      <Footer/>
      </footer>
